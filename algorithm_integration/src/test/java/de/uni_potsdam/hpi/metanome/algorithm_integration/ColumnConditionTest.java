...
public class ColumnConditionTest {
  ...
  public void testEqualsHashCode() {
    ...
    ColumnCondition
        columnCondition1 =
        new ColumnCondition(column11,
                            conditionValues1.toArray(new String[conditionValues1.size()]));

    ColumnCondition
        columnConditionEq =
        new ColumnCondition(column21,
                            conditionValues1.toArray(new String[conditionValues1.size()]));
    ColumnCondition
        columnConditionEq2 =
        new ColumnCondition(column11,
                            conditionValues2.toArray(new String[conditionValues2.size()]));

    ColumnCondition
        columnConditionNotEq =
        new ColumnCondition(column12,
                            conditionValues1.toArray(new String[conditionValues1.size()]));
    ColumnCondition
        columnConditionNotEq2 =
        new ColumnCondition(column11,
                            conditionValues3.toArray(new String[conditionValues3.size()]));
