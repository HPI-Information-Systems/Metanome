...
public class ConfigurationSpecificationRelationalInputTest {
  ...
  /**
   * Test method for {@link de.uni_potsdam.hpi.metanome.algorithm_integration.configuration.ConfigurationSpecificationRelationalInput#ConfigurationSpecificationRelationalInput(String)}
   *
  ...
  /**
   * Tests that the instances of {@link de.uni_potsdam.hpi.metanome.algorithm_integration.configuration.ConfigurationSpecificationRelationalInput}
