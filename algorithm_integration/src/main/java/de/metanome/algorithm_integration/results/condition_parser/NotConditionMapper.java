...
public class NotConditionMapper
    implements Map2<Void, ColumnCondition, ColumnCondition> {

  @Override
  public ColumnCondition map(Void aVoid, ColumnCondition columnCondition) {
