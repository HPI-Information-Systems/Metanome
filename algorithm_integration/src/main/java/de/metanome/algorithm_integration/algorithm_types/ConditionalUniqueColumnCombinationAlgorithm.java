...
/**
 * An {@link de.metanome.algorithm_integration.Algorithm} that discovers conditional unique {@link
...
public interface ConditionalUniqueColumnCombinationAlgorithm extends Algorithm {
  ...
  /**
   * Sets a {@link de.metanome.algorithm_integration.result_receiver.UniqueColumnCombinationResultReceiver}
