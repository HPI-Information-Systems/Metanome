...
/**
 * Receives the results of a {@link MatchingDependencyAlgorithm}.
 */
public interface MatchingDependencyResultReceiver {

  /**
   * Receives a {@link MatchingDependency} from a {@link MatchingDependencyAlgorithm}.
   *
   * @param matchingDependency a found {@link MatchingDependency}
   ...
   * names of the input
   */
  void receiveResult(MatchingDependency matchingDependency)
   ...
   */
  Boolean acceptedResult(MatchingDependency result);
}
