...
/**
 * Receives the results of a {@link MultivaluedDependencyAlgorithm}.
 */
public interface MultivaluedDependencyResultReceiver {

  /**
   * Receives a {@link MultivaluedDependency} from a {@link MultivaluedDependencyAlgorithm}.
   *
   * @param multivaluedDependency a found {@link de.metanome.algorithm_integration.results.MultivaluedDependency}
   ...
   */
  void receiveResult(MultivaluedDependency multivaluedDependency)
   ...
   */
  Boolean acceptedResult(MultivaluedDependency result);
}
