...
/**
 * Receives the results of a {@link ConditionalInclusionDependencyAlgorithm}.
 */
public interface ConditionalInclusionDependencyResultReceiver {

  /**
   * Receives a {@link ConditionalInclusionDependency} from a {@link ConditionalInclusionDependencyAlgorithm}.
   *
   * @param conditionalDependency a found {@link de.metanome.algorithm_integration.results.ConditionalInclusionDependency}
   ...
   */
  void receiveResult(ConditionalInclusionDependency conditionalDependency)
   ...
   */
  Boolean acceptedResult(ConditionalInclusionDependency result);
}
