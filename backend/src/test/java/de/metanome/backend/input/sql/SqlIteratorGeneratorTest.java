...
public class SqlIteratorGeneratorTest {
   ...
   * de.metanome.backend.input.sql.SqlIteratorGenerator#SqlIteratorGenerator(String, String,
   * String)}
   *
   ...
   * de.metanome.backend.input.sql.SqlIteratorGenerator#setFetchSize(int)} <p/> The setter should
   * return this, to enable cascades.
   */
  @Test
   ...
   * de.metanome.backend.input.sql.SqlIteratorGenerator#setResultSetType(int)} <p/> The setter
   ...
   * de.metanome.backend.input.sql.SqlIteratorGenerator#setResultSetConcurrency(int)} <p/> The
  ...
  /**
   * Test method for {@link de.metanome.backend.input.sql.SqlIteratorGenerator#executeQuery(String)}
