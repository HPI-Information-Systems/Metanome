...
/**
 * Test for {@link de.metanome.backend.results_db.ExecutionId}
 *
...
public class ExecutionIdTest {
  ...
  /**
   * Test method for {@link ExecutionId#getAlgorithm()} and {@link de.metanome.backend.results_db.ExecutionId#setAlgorithm(Algorithm)}
   */
  @Test
  ...
  /**
   * Test method for {@link ExecutionId#getBegin()} and {@link de.metanome.backend.results_db.ExecutionId#setBegin(java.sql.Timestamp)}
   */
  @Test
