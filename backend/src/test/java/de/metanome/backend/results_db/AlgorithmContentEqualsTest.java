...
/**
 * Tests for {@link de.metanome.backend.results_db.AlgorithmContentEquals}
 */
public class AlgorithmContentEqualsTest {

  /**
   * Test method for {@link de.metanome.backend.results_db.AlgorithmContentEquals#contentEquals(Algorithm,
