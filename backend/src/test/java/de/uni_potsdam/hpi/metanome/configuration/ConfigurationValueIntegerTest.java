...
public class ConfigurationValueIntegerTest {
	...
	/**
	 * Test method for {@link ConfigurationValueInteger#triggerSetValue(de.uni_potsdam.hpi.metanome.algorithm_integration.Algorithm, java.util.Set)}
	 * <p/>
	...
	public void testTriggerSetValue() throws AlgorithmConfigurationException {
		...
		ConfigurationValueInteger configValue = new ConfigurationValueInteger(
				new ConfigurationSpecificationInteger(expectedIdentifier).getIdentifier(), expectedConfigurationValue);
