...
public class AlgorithmExecutorTest {
  ...
  public void executeInclusionDependencyTest()
    ...
    configs.add(
        new ConfigurationValueFileInputGenerator(ExampleAlgorithm.CSV_FILE_IDENTIFIER, fileInputs));
  ...
  public void testExecuteIndirectInterfaceAlgorithm()
    ...
    // Execute functionality
    executor.executeAlgorithmWithValues("example_indirect_interfaces_algorithm.jar",
                                        configurationValues);
