...
public class AlgorithmContentEqualsTest {
    ...
    /**
     * Test method for {@link de.uni_potsdam.hpi.metanome.results_db.AlgorithmContentEquals#contentEquals(Algorithm, Algorithm)}
     * <p/>
     * When in the first algorithm all fields are set, check, that only algorithms are equal, that exhibit equal values
     * in all fields.
     */
    @Test
     ...
     * Test method for {@link de.uni_potsdam.hpi.metanome.results_db.AlgorithmContentEquals#contentEquals(Algorithm, Algorithm)}
     * <p/>
     * Algorithms that have fields set to null are equal to otherwise equal algorithms that exhibit null values in the
     * same fields.
     */
    @Test
