...
public class FileInputTest {
  ...
  /**
   * Test method for {@link de.uni_potsdam.hpi.metanome.results_db.FileInput#store(Input)} and
   * {@link de.uni_potsdam.hpi.metanome.results_db.FileInput#retrieve(long)} <p/> FileInputs should
   * be storable and retrievable by id.
   */
  @Test
   ...
   *
   * After calling the constructor with a file name, the file name should be set and the default
   * parser settings.
   */
  @Test
