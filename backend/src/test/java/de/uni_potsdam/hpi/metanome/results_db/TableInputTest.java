...
public class TableInputTest {
  ...
  /**
   * Test method for {@link de.uni_potsdam.hpi.metanome.results_db.TableInput#store(Input)} and
   * {@link de.uni_potsdam.hpi.metanome.results_db.TableInput#retrieve(long)} <p/> TableInputs
