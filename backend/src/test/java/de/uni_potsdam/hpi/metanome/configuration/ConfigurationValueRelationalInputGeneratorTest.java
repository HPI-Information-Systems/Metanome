...
public class ConfigurationValueRelationalInputGeneratorTest {
  ...
  /**
   * Test method for {@link de.uni_potsdam.hpi.metanome.configuration.ConfigurationValueRelationalInputGenerator#triggerSetValue(de.metanome.algorithm_integration.Algorithm,
