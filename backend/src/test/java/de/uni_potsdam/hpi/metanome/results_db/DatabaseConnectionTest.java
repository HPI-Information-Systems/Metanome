...
public class DatabaseConnectionTest {
  ...
  /**
   * Test method for {@link de.uni_potsdam.hpi.metanome.results_db.DatabaseConnection#store(DatabaseConnection)}
   * and {@link de.uni_potsdam.hpi.metanome.results_db.DatabaseConnection#retrieve(long)} <p/>
