...
public class AlgorithmExecutor implements Closeable {
    ...
    public long executeAlgorithmWithValues(String algorithmFileName,
        ...
        if (interfaces.contains(ConditionalUniqueColumnCombination.class)) {
            ConditionalUniqueColumnCombinationAlgorithm cuccAlgorithm = (ConditionalUniqueColumnCombinationAlgorithm) algorithm;
