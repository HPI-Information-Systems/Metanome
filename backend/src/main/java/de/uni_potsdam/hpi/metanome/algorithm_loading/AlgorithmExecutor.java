...
public class AlgorithmExecutor implements Closeable {
     ...
     *
     * @param resultReceiver the result receiver the algorihtm sends all results to
     * @param fileGenerator  the file generator for temporary files
     */
     ...
     * returned as long.
     *
     * @param algorithmFileName the algorithm jar's file name
     * @param configs           all configuration values for the algorithm
     * @return elapsed time in ns
     * @throws AlgorithmLoadingException
     * @throws AlgorithmConfigurationException
     * @throws AlgorithmExecutionException
     */
    public long executeAlgorithm(String algorithmFileName, List<ConfigurationValue> configs) throws AlgorithmLoadingException, AlgorithmConfigurationException, AlgorithmExecutionException {
