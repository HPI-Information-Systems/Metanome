...
/**
 * Calculates the rankings for conditional inclusion dependency results.
 */
public class ConditionalInclusionDependencyRanking extends Ranking{
    
    protected List<ConditionalInclusionDependencyResult> results;

    public ConditionalInclusionDependencyRanking(List<ConditionalInclusionDependencyResult> results,
