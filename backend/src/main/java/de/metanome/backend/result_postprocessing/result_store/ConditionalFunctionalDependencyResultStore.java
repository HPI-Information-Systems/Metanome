...
import de.metanome.backend.result_postprocessing.result_comparator.ConditionalFunctionalDependencyResultComparator;
...
public class ConditionalFunctionalDependencyResultStore extends ResultsStore<ConditionalFunctionalDependencyResult> {
   ...
   */
  @Override
  protected ResultComparator<ConditionalFunctionalDependencyResult> getResultComparator(String sortProperty,
                                                                             boolean ascending) {
    return new ConditionalFunctionalDependencyResultComparator(sortProperty, ascending);
  }
