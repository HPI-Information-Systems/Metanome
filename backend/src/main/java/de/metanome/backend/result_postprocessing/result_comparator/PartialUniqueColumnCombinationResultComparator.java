...
/**
 * Defines a partial unique column combination comparator based on a predefined sort property
 * and sort direction order.
 */
public class PartialUniqueColumnCombinationResultComparator
     ...
     */
    public PartialUniqueColumnCombinationResultComparator(String sortProperty,
                                                              boolean isAscending) {
    ...
    protected int compare(PartialUniqueColumnCombinationResult pucc1,
                          PartialUniqueColumnCombinationResult pucc2, String sortProperty) {
