...
public class MultivaluedDependencyRanking extends Ranking {
  ...
  public MultivaluedDependencyRanking(List<MultivaluedDependencyResult> results,
   ...
   */
  protected void calculateColumnRatios(MultivaluedDependencyResult result) {
   ...
   * @param result the result
   */
  protected void calculateGeneralCoverage(MultivaluedDependencyResult result) {
   ...
   * @param result the result
   */
  protected void calculateOccurrenceRatios(MultivaluedDependencyResult result) {
   ...
   * @param result the result
   */
  protected void calculateUniquenessRatios(MultivaluedDependencyResult result) {
   ...
   */
  protected void calculatePollution(MultivaluedDependencyResult result,
   ...
   */
  protected void calculateInformationGainCells(MultivaluedDependencyResult result,
                                               TableInformation tableInformation) {
   ...
   * @param tableInformation the table
   */
  protected void calculateInformationGainBytes(MultivaluedDependencyResult result,
                                               TableInformation tableInformation) {
    long rowCount = tableInformation.getRowCount();
