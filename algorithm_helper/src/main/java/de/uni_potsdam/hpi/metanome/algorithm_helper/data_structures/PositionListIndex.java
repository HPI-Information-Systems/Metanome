...
/**
 * Position list indices (or stripped partitions) are an index structure that stores the positions of equal values in a nested list. A column with the values a, a, b, c, b, c transfers to the position list index ((0, 1), (2, 4), (3, 5)). Clusters of size 1 are discarded.
...
public class PositionListIndex {
    ...
    /**
     * Returns the position list index in a map representation. Every row index maps to a value reconstruction. As the original values are unknown they are represented by a counter. The position list index ((0, 1), (2, 4), (3, 5)) would be represented by {0=0, 1=0, 2=1, 3=2, 4=1, 5=2}.
     *
