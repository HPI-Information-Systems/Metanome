...
public class IndirectInterfacesAlgorithmTest {
    ...
    /**
     * Test method for {@link IndirectInterfacesAlgorithm#execute()}
     * <p/>
     * The algorithm should only return a result if the result receiver, the progress receiver and the input are set.
     *
    ...
    public void testExecute() throws AlgorithmExecutionException {
        ...
        algorithm.setRelationalInputConfigurationValue("identifier", mock(RelationalInputGenerator.class));
        algorithm.execute();
