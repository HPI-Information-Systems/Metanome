!function (a, b) {
  "use strict";
  if ("object" == typeof exports)module.exports = b(require("d3")); else if ("function" == typeof define && define.amd)define(["d3"], function (c) {
    return a.dimple = b(c), a.dimple
  }); else if (a.d3)a.dimple = b(a.d3); else {
  ...
  "use strict";
  var b = {version: "2.1.2", plot: {}, aggregateMethod: {}};
  return b.axis = function (c, d, e, f, g) {
    this.chart = c, this.position = d, this.categoryFields = null === g || void 0 === g ? e : [].concat(g), this.measure = f, this.timeField = g, this.floatingBarWidth = 5, this.hidden = !1, this.showPercent = !1, this.colors = null, this.overrideMin = null, this.overrideMax = null, this.shapes = null, this.showGridlines = null, this.gridlineShapes = null, this.titleShape = null, this.dateParseFormat = null, this.tickFormat = null, this.timePeriod = null, this.timeInterval = 1, this.useLog = !1, this.logBase = 10, this.title = void 0, this.clamp = !0, this.ticks = null, this.fontSize = "10px", this.fontFamily = "sans-serif", this._slaves = [], this._scale = null, this._min = 0, this._max = 0, this._previousOrigin = null, this._origin = null, this._orderRules = [], this._groupOrderRules = [], this._draw = null, this._getAxisData = function () {
      ...
      return null !== this.tickFormat && void 0 !== this.tickFormat ? b = this._hasTimeField() ? a.time.format(this.tickFormat) : a.format(this.tickFormat) : this.showPercent ? b = a.format("%") : this.useLog && null !== this.measure ? b = function (b) {
        var c = Math.floor(Math.abs(b), 0).toString().length, d = Math.min(Math.floor((c - 1) / 3), 4), e = "kmBT".substring(d - 1, d), f = "0" === Math.round(10 * (b / Math.pow(1e3, d))).toString().slice(-1) ? 0 : 1;
    ...
    this.svg = c, this.x = "10%", this.y = "10%", this.width = "80%", this.height = "80%", this.data = d, this.noFormats = !1, this.axes = [], this.series = [], this.legends = [], this.storyboard = null, this.titleShape = null, this.shapes = null, this.ease = "cubic-in-out", this.staggerDraw = !1, this._group = c.append("g"), this._tooltipGroup = null, this._assignedColors = {}, this._assignedClasses = {}, this._nextColor = 0, this._nextClass = 0, this._axisIndex = function (a, b) {
      ...
      }, q = {x: !1, y: !1, z: !1, p: !1, c: !1}, r = {x: [], y: []}, s = {x: [], y: [], z: [], p: []}, t = {
        min: null,
        max: null
      }, u = {x: [], y: [], z: [], p: []}, v = [], w = {}, x = {
        x: 0,
      ...
      null !== this.series && void 0 !== this.series && this.series.forEach(function (a) {
        var b, c, d, e, f, g, h = a.data || this.data || [], i = [].concat(a.categoryFields || "All"), j = this._getData(h, i, a.aggregate, a._orderRules, a._isStacked(), a.x, a.y, a.z, a.p, a.c), k = [], l = {}, m = a.startAngle * (Math.PI / 180) || 0, n = (a.endAngle || 360) * (Math.PI / 180);
      ...
      b = b || 0;
      var d, e, f = null, g = null, h = !1, i = !1, j = this._xPixels(), k = this._yPixels(), l = this._widthPixels(), m = this._heightPixels();
      return (void 0 === c || null === c || c === !1) && this._getSeriesData(), this.axes.forEach(function (a) {
        ...
        var d = !1, e = null, n = 0, o = null, p = !1, q = 0, r = {
          l: null,
          t: null,
          r: null,
          b: null
        }, s = 0, t = 0, u = "", v = this, w = function (a) {
          var c;
        ...
        }), (null === c.measure || void 0 === c.measure) && (c === f ? (q = 0, c.shapes.selectAll("text").each(function () {
        ...
        })) : (p = !1, c.shapes.selectAll("text").style("text-anchor", "middle").attr("transform", "")))), null !== c.titleShape && void 0 !== c.titleShape && c.titleShape.remove(), c.shapes.selectAll("text").each(function () {
          var a = this.getBBox();
    ...
    this.chart = c, this.series = i, this.x = d, this.y = e, this.width = f, this.height = g, this.horizontalAlign = h, this.shapes = null, this.fontSize = "10px", this.fontFamily = "sans-serif", this._draw = function () {
      var c, d = this._getEntries(), e = 0, f = 0, g = 0, h = 0, i = 15, j = 9, k = this;
      this.shapes && this.shapes.remove(), c = this.chart._group.selectAll(".dimple-dont-select-any").data(d).enter().append("g").attr("class", function (a) {
        ...
        return "dimple-legend dimple-legend-text " + b._createClass(a.aggField) + " " + k.chart.customClassList.legendLabel
      }).text(function (a) {
        return a.key
      }).call(function () {
        k.chart.noFormats || this.style("font-family", k.fontFamily).style("font-size", k._getFontSize()).style("shape-rendering", "crispEdges")
      }).each(function () {
        var a = this.getBBox();
      ...
      }).attr("height", j).attr("width", i), f = (j > f ? j : f) + 2, e += i + 20, c.each(function (c) {
        g + e > k._widthPixels() && (g = 0, h += f), h > k._heightPixels() ? a.select(this).remove() : (a.select(this).select("text").attr("x", "left" === k.horizontalAlign ? k._xPixels() + i + 5 + g : k._xPixels() + (k._widthPixels() - g - e) + i + 5).attr("y", function () {
          return k._yPixels() + h + this.getBBox().height / 1.65
        }).attr("width", k._widthPixels()).attr("height", k._heightPixels()), a.select(this).select("rect").attr("class", function (a) {
          return "dimple-legend dimple-legend-key " + b._createClass(a.aggField) + " " + k.chart.customClassList.legendKey + " " + a.css
        }).attr("x", "left" === k.horizontalAlign ? k._xPixels() + g : k._xPixels() + (k._widthPixels() - g - e)).attr("y", k._yPixels() + h).attr("height", j).attr("width", i).call(function () {
          k.chart.noFormats || this.style("fill", c.fill).style("stroke", c.stroke).style("opacity", c.opacity).style("shape-rendering", "crispEdges")
        }), g += e)
      }), this.shapes = c
      ...
      return this.series && this.series.forEach(function (b) {
        ...
        c.forEach(function (c) {
          var d, e = -1, f = b.plot.grouped && !b.x._hasCategories() && !b.y._hasCategories() && c.aggField.length < 2 ? "All" : c.aggField.slice(-1)[0];
    ...
    stacked: !0, grouped: !0, supportedAxes: ["x", "y", "c"], draw: function (c, d, e) {
      var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B = d._positionData, C = [], D = null, E = "dimple-series-" + c.series.indexOf(d), F = d.x._hasCategories() || d.y._hasCategories() ? 0 : 1, G = !1, H = {}, I = [], J = [], K = function () {
        ...
        b._drawMarkers(a, c, d, e, E, G, K(a), L(a))
      }, N = function (a, e) {
        var f;
      ...
      null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove(), D = null === d.shapes || void 0 === d.shapes ? c._group.selectAll("." + E).data(C) : d.shapes.data(C, function (a) {
        ...
        c.noFormats || this.attr("opacity", function (a) {
          ...
          return G ? "url(#fill-area-gradient-" + a.keyString + ")" : a.color.fill
        }).attr("stroke", function (a) {
          return G ? "url(#stroke-area-gradient-" + a.keyString + ")" : a.color.stroke
        }).attr("stroke-width", d.lineWeight)
      }).each(function (a) {
        a.markerData = a.data, M(a)
    ...
    stacked: !0, grouped: !1, supportedAxes: ["x", "y", "c"], draw: function (a, c, d) {
      var e, f, g = c._positionData, h = null, i = ["dimple-series-" + a.series.indexOf(c), "dimple-bar"], j = !c._isStacked() && c.x._hasMeasure(), k = !c._isStacked() && c.y._hasMeasure(), l = "none";
    ...
    stacked: !1, grouped: !0, supportedAxes: ["x", "y", "c"], draw: function (c, d, e) {
      var f, g, h, i, j, k, l, m, n, o, p = d._positionData, q = [], r = null, s = "dimple-series-" + c.series.indexOf(d), t = d.x._hasCategories() || d.y._hasCategories() ? 0 : 1, u = !1, v = function () {
        return function (c, d, e, f) {
          a.select(d).style("opacity", 1), b._showPointTooltip(c, d, e, f)
        }
      }, w = function (c) {
        ...
        b._drawMarkers(a, c, d, e, s, u, v(a), w(a))
      }, y = function (a, e) {
        var f;
      ...
      null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove(), r = null === d.shapes || void 0 === d.shapes ? c._group.selectAll("." + s).data(q) : d.shapes.data(q, function (a) {
        ...
        c.noFormats || this.attr("opacity", function (a) {
          ...
          return u ? "url(#fill-line-gradient-" + a.keyString + ")" : a.color.stroke
        }).attr("stroke-width", d.lineWeight)
      }).each(function (a) {
        a.markerData = a.data, x(a)
    ...
    stacked: !1, grouped: !1, supportedAxes: ["x", "y", "c", "z", "p"], draw: function (c, d, e) {
      var f, g, h = d._positionData, i = null, j = ["dimple-series-" + c.series.indexOf(d), "dimple-pie"], k = function (a) {
        var e;
        ...
        var c;
        return c = a.svg.arc().innerRadius(m(b)).outerRadius(l(b)), c(b)
      }, o = function (b) {
      ...
      null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove(), i = null === d.shapes || void 0 === d.shapes ? c._group.selectAll("." + j.join(".")).data(h) : d.shapes.data(h, function (a) {
      ...
      }).attr("d", n).attr("opacity", function (a) {
        ...
        c.noFormats || this.attr("fill", function (a) {
  ...
  }, b._addGradient = function (a, b, c, d, e, f, g) {
    var h = [].concat(a), i = e._group.select("#" + b), j = [], k = c.position + "Field", l = !0, m = [];
    d.forEach(function (a) {
      ...
      var c = {}, e = 0;
      for (e = 0; e < d.length; e += 1)if (d[e].aggField.join("_") === h.join("_") && d[e][k].join("_") === a.join("_")) {
        c = d[e];
        break
      }
      m.push({offset: Math.round(100 * (b / (j.length - 1))) + "%", color: c[g]})
    ...
    if (a.length > 0)for (b = 0; b < a.length; b += 1)c.push("dimple-" + a[b].toString().replace(/[^a-z0-9]/g, d)); else c = ["dimple-all"];
    return c.join(" ")
  }, b._drawMarkerBacks = function (c, d, e, f, g) {
    var h, i, j = ["dimple-marker-back", g, c.keyString];
    e.lineMarkers && (h = null === e._markerBacks || void 0 === e._markerBacks || void 0 === e._markerBacks[c.keyString] ? d._group.selectAll("." + j.join(".")).data(c.markerData) : e._markerBacks[c.keyString].data(c.markerData, function (a) {
      return a.key
    }), h.enter().append("circle").attr("id", function (a) {
      return a.key
    }).attr("class", function (a) {
      var c = [];
      return e.x._hasCategories() && (c = c.concat(a.xField)), e.y._hasCategories() && (c = c.concat(a.yField)), b._createClass(c) + " " + j.join(" ")
    }).attr("cx", function (a) {
    ...
    }).attr("r", 0).attr("fill", "white").attr("stroke", "none"), d._handleTransition(h, f, d).attr("cx", function (a) {
      return b._helpers.cx(a, d, e)
    }).attr("cy", function (a) {
      return b._helpers.cy(a, d, e)
    }).attr("r", 2 + e.lineWeight), i = d._handleTransition(h.exit(), f, d).attr("cx", function (a) {
      return e.x._hasCategories() ? b._helpers.cx(a, d, e) : e.x._origin
    }).attr("cy", function (a) {
      return e.y._hasCategories() ? b._helpers.cy(a, d, e) : e.y._origin
    }).attr("r", 0), 0 === f ? i.remove() : i.each("end", function () {
      a.select(this).remove()
    }), (void 0 === e._markerBacks || null === e._markerBacks) && (e._markerBacks = {}), e._markerBacks[c.keyString] = h)
  }, b._drawMarkers = function (c, d, e, f, g, h, i, j) {
    var k, l, m = ["dimple-marker", g, c.keyString];
    b._drawMarkerBacks(c, d, e, f, g), k = null === e._markers || void 0 === e._markers || void 0 === e._markers[c.keyString] ? d._group.selectAll("." + m.join(".")).data(c.markerData) : e._markers[c.keyString].data(c.markerData, function (a) {
      return a.key
    }), k.enter().append("circle").attr("id", function (a) {
      return a.key
    }).attr("class", function (a) {
      var c = [];
      return e.x._hasCategories() && (c = c.concat(a.xField)), e.y._hasCategories() && (c = c.concat(a.yField)), b._createClass(c) + " " + m.join(" ") + " " + d.customClassList.lineMarker
    }).on("mouseover", function (a) {
      i(a, this, d, e)
    }).on("mouseleave", function (a) {
      j(a, this, d, e)
    ...
    }), d._handleTransition(k, f, d).attr("cx", function (a) {
      return b._helpers.cx(a, d, e)
    }).attr("cy", function (a) {
      return b._helpers.cy(a, d, e)
    ...
    }), l = d._handleTransition(k.exit(), f, d).attr("cx", function (a) {
      return e.x._hasCategories() ? b._helpers.cx(a, d, e) : e.x._origin
    }).attr("cy", function (a) {
      return e.y._hasCategories() ? b._helpers.cy(a, d, e) : e.y._origin
    }).attr("r", 0), 0 === f ? l.remove() : l.each("end", function () {
      a.select(this).remove()
    }), (void 0 === e._markers || null === e._markers) && (e._markers = {}), e._markers[c.keyString] = k
  ...
  }, b._removeTooltip = function (a, b, c) {
