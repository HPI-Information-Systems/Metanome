...
import de.uni_potsdam.hpi.metanome.frontend.client.jarchooser.UniqueColumnCombinationsJarChooser;
...
public class UniqueColumnCombinationTab extends AlgorithmTab {
	...
	public void callExecutionService(List<InputParameter> parameters) {
		...
		executionService.executeUniqueColumnCombinationsAlgorithm(algorithmName, parameters, callback);
