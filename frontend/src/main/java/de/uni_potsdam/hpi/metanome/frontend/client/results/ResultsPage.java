...
public class ResultsPage extends VerticalPanel implements TabContent {
  ...
  public ResultsPage(BasePage parent) {
    ...
    this.add(
        new Label("Here goes a list of previous executions, with some filtering options.     "));
    this.add(new Label(
        "And on the right half we can have the results of the execution selected on the left."));
  }
