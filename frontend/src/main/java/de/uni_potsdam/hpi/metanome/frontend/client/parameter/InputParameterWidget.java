...
public abstract class InputParameterWidget extends VerticalPanel implements IsWidget {
    ...
    public InputParameterWidget(ConfigurationSpecification config) {
        ...
        if (this.getSpecification().getNumberOfValues() == ConfigurationSpecification.ARBITRARY_NUMBER_OF_VALUES) {
    ...
    /**
     * Adds a button beneath all input fields that, when clicked, adds another input field (checkbox, textbox, or whatever
     * is appropriate for the implementing class.
     */
    ...
    public abstract ConfigurationSpecification getUpdatedSpecification() throws AlgorithmConfigurationException;
