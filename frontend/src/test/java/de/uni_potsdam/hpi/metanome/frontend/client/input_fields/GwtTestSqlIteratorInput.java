...
public class GwtTestSqlIteratorInput extends GWTTestCase {
  ...
  /**
   * Test method for {@link de.uni_potsdam.hpi.metanome.frontend.client.input_fields.SqlIteratorInput#SqlIteratorInput(boolean,
   * de.uni_potsdam.hpi.metanome.frontend.client.TabWrapper)} <p/> After calling the constructor the
