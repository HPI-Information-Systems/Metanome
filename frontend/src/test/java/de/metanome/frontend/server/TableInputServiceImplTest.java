...
/**
 * Tests for {@link de.metanome.frontend.server.TableInputServiceImpl}
 */
public class TableInputServiceImplTest {
  ...
  /**
   * Test method for {@link de.metanome.frontend.server.TableInputServiceImpl#getTableInput(long)}
   */
  @Test
  ...
  /**
   * Test method for {@link de.metanome.frontend.server.TableInputServiceImpl#storeTableInput(de.metanome.backend.results_db.TableInput)}
   */
  @Test
  ...
  /**
   * Test method for {@link de.metanome.frontend.server.TableInputServiceImpl#deleteTableInput(de.metanome.backend.results_db.TableInput)}
   */
  @Test
