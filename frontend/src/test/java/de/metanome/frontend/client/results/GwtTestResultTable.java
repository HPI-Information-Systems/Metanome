...
public class GwtTestResultTable extends GWTTestCase {
  ...
  /**
   * Test method for {@link de.metanome.frontend.client.results.ResultTable#setText(int, int,
   * String)} and for {@link de.metanome.frontend.client.results.ResultTable#getRowCount()}
   */
